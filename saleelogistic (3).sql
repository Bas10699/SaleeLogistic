...
--
-- Host: localhost
-- Generation Time: Apr 02, 2020 at 02:38 PM
...
(19, 'C-019', 'กว5432', 'ชลบุรี', '2020-10-16'),
(20, 'C-020', 'กว5432', 'ตรัง', '2020-08-12');
...
(15, '2020-04-01 18:20:04', 4, 6, '26,27,29,30');
...
CREATE TABLE `tb_inv_wb` (
  ...
  `tiw_payment_status` varchar(20) NOT NULL DEFAULT 'ค้างชำระ'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tb_inv_wb` (`tiw_id`, `tiw_wb_id`, `tiw_date`, `tiw_money`, `tiw_payment_status`) VALUES
(1, 26, '2020-04-01 18:20:04', 1500, 'ค้างชำระ'),
(2, 27, '2020-04-01 18:20:04', 6000, 'ชำระเงินแล้ว'),
(3, 29, '2020-04-01 18:20:04', 400, 'ชำระเงินแล้ว'),
(4, 30, '2020-04-01 18:20:04', 500, 'ค้างชำระ');
...
(23, 'S-023', 'ยุท', 'มุดหนี', '1234567890123', 'Manager', '0123456789', 'นาย');
...
(30, '366', '2020-01-13', 900, 'ยังไม่ได้ชำระ', 'B-0030.', '79987', '5', 4, 'B-0030', 1, 6),
(29, '80', '2020-01-13', 350, 'ยังไม่ได้ชำระ', 'เธเธดเธฅเน€เธเธดเธเธชเธ”.jpg', '888888', '10', 4, 'B-0029', 1, 6),
...
(26, '4545', '2020-01-22', 50000, '', 'B-0026.jpg', '222', '5', 4, 'B-0026', 1, 6),
(27, '55', '2020-01-08', 6000, 'ยังไม่ได้ชำระ', 'B-0027.jpg', '555', '2', 4, 'B-0027', 1, 6),
...
--
ALTER TABLE `tb_car`
  MODIFY `car_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
--
...
--
ALTER TABLE `tb_inv_wb`
  MODIFY `tiw_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
